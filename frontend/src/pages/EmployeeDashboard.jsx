                ...
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      ...
                      <dd className="text-lg font-medium text-gray-900">42.5</dd>
                    </dl>
                  </div>
                </div>
              </div>
                        ...
                        <div className="relative flex space-x-3">
                          ...
                          <div className="min-w-0 flex-1 pt-1.5">
                            <p className="text-sm text-gray-500">
                              Completed project review for <span className="font-medium text-gray-900">Q4 Marketing Campaign</span>
                            </p>
                    ...
                    <li>
                      <div className="relative pb-8">
                        ...
                        <div className="relative flex space-x-3">
                          ...
                          <div className="min-w-0 flex-1 pt-1.5">
                            <p className="text-sm text-gray-500">
                              Submitted weekly report to <span className="font-medium text-gray-900">management team</span>
                            </p>
                    ...
                    <li>
                      <div className="relative pb-8">
                        <div className="relative flex space-x-3">
                          ...
                          <div className="min-w-0 flex-1 pt-1.5">
                            <p className="text-sm text-gray-500">
                              Attended team meeting for <span className="font-medium text-gray-900">product roadmap planning</span>
                            </p>
